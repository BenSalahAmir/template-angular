...
public class KeycloakAdminClientService {
    ...
    public String KEYCLOAK_SERVER_URL;
...
*/
    ...
    public String getLoggedInUserId(String accessToken) {
        ...
        UserRepresentation userRepresentation = keycloak.realm(realm).users().search(null, null, null, null, null, null)
                .stream().filter(user -> user.getUsername().equals(keycloak.tokenManager().getAccessTokenString())).findFirst()
    ...
    public UserRepresentation getUserById(String userId) {
        Keycloak keycloak = KeycloakBuilder.builder()
                .serverUrl(kcProvider.serverURL)
                .realm(kcProvider.realm)
                .clientId(kcProvider.clientID)
                .clientSecret(kcProvider.clientSecret)
                .username("admin")
                .password("admin")
                .build();

        UserResource userResource = keycloak.realm(kcProvider.realm).users().get(userId);
